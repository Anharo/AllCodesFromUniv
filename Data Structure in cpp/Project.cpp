...
int main() {
    ...
    do {
        ...
        cout << "Type 1 for Array " << endl;
        cout << "Type 2 for Linked List" << endl;
        cout << "Type 3 for Stack" << endl;
        cout << "Type 4 for Queue" << endl;
        cout << "Type 5 for Tree" << endl;
        cout << "Type 6 for Search" << endl;
        cout << "Type 7 for Sort" << endl;
        cout << "Type 8 to Exit the code" << endl;
             ...
             do {
                 ...
                 switch (choice) {
                     case 1:{
                         ...
                         cin >> key;
                         int ioo= sc.linearSearch(arr, n, key);
                         if (ioo!= -1) {
                             cout << "Linear search: Element found" << "At "<<++ioo<< endl;
                         } else {
                     ...
                     case 2:{
                         cout << "Enter the key to search for: ";
                         cin >> key;
                         int y= sc.binarySearch(arr, 0, n - 1, key); 
                         if (y!= -1) {
                             cout << "Binary search: Element found " << "At "<< ++y << endl;
                         } else {
